...
export class Demo extends Component {
  ...
  reset() {
    ...
    this.setState({ rawMessages: [], formattedMessages: [], error: null, response: null });
  }
  ...
  async handleSubmit() {
    ...
    const submit = this.getFinalAndLatestInterimResult();
    const data = submit.map((text) => text.results[0].alternatives[0].transcript);
    let dataString = '';
    data.forEach((ds) => { dataString = dataString + ds + ',' });
    ...
    this.setState({ response: responseData.body, isLoading: false });
  }
  ...
  render() {
    ...
    return (
      <>
        ...
        >
          ...
          <div className="drop-info-container">
            <div className="drop-info">
              ...
              <p>Speech to Text supports .mp3, .mpeg, .wav, .opus, and
          ...
          <ul className="base--ul">
            {micBullet}
            <li className="base--li">Upload pre-recorded audio .</li>
          </ul>
          ...
          <div className="flex buttons">
            ...
            <button type="button" className={buttonClass} onClick={this.handleSubmit}>
              <Icon type={'link-out'} /> Submit Transcript
          </button>
        ...
        {this.state.response &&
          <div style={{margin: 'auto', maxWidth:'1024px', padding: '1rem 1rem'}}>
            <h2 className="base--h2">
              Corrected Passage
            </h2>
            <h5 style={{border: 'solid 1px black', fontFamily: 'sans-serif', height: '30vh'}}>
              {this.state.response}
            </h5>
          </div>
        }
